...
- Dot-prefixed directories (`.github/`, `.git/`, etc.)
- Package/dependency directories (`node_modules/`, `vendor/`, `.venv/`, etc.)
- Archive/backup directories (names containing `archive`, `backup`, `bak`)
- External libraries (`addons/`, `plugins/`, `third_party/`, `external/`, `lib/`, `libs/`)
- Generated directories (`dist/`, `build/`, `.next/`, `out/`, `specs/` if generated)
